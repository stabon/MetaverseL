...
import { fadeIn, staggerContainer, zoomIn } 
from '../utils/motion';
    ...
    <motion.div 
      ...
      >
        <motion.div
          ...
          rounded-[30px] border-[1px] border-[#6a6a6a]
          relative"
          >
            <div className='feedback-gradient'/>
            <div>
              <h4 className='font-bold sm:text-[30px]
              text-[26px] sm:leading-[40px] leading-[36px]
              text-white'>
                Samatha
              </h4>
              <p className='mt-[8px] font-normal sm:text-[18px]
              text-[12px] sm:leading-[22px] 
        ...
        <motion.div
          ...
          className='relative flex-1 flex justify
          -center items-center'
          >
            <img 
            src='/planet-09.png'
